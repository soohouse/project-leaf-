...
<div class="modal fade" id="modal-pass-list" role="dialog" data-backdrop="static">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body modal-body-sections" style="width: 560px; margin: 0 auto;">
				<a href="#" class="list-group-item active notice-list-top" style="cursor: default;"> 
					...
					<span class="pull-right" style="font-size: 12px; color: #737373;">지원자 : <span id="span-pass-count" style="color: red;"></span> 명</span>
				</a>
				...
				<table class="table table-bordered table-condensed" style="margin-top: 20px;">
					<thead style="width: 10px; font-size: 13px; background: #F5E4FE;">
						<tr style="font-family: sans-serif; font-size: 12px;">
							<th style="width: 7%;">순번</th>
							<th style="width: 20%;">ID</th>
							<th style="width: 20%;">이름</th>
							<th style="width: 28%;">지원 날짜</th>
							<th style="width: 25%;">지원 현황</th>
						</tr>
					</thead>
					<tbody id="modalPassList" style="width: 10px; font-size: 10px; background: #FCFCFC;">
